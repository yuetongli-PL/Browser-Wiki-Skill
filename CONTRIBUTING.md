...
Redaction. The deep remaining paths now have focused evidence: real producer
...
- Next smallest task: Add site-specific live producer fixtures and upper runtime consumers only through the established guarded paths.

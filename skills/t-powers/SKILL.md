---
name: t-powers
description: Instruction-only Skill for the verified https://www.t-powers.co.jp/ URL family. Use when Codex needs read-only public navigation, search, list pagination, or profile/detail metadata extraction for T-Powers official pages.
---
...
- `https://www.t-powers.co.jp/`
- `https://t-powers.co.jp/`
...
- Open public landing, search, list, profile, news, schedule, and detail pages.
...
- Stay inside `t-powers.co.jp` / `www.t-powers.co.jp` public pages.
...
- No native downloader is claimed for `t-powers`.
...
- T-POWERS profile semantics are usable for public profile/list/detail interpretation through SiteAdapter/onboarding evidence.
...
- Confirm generated files are limited to `skills/t-powers/`.
...
- `outside-url-family`: link leaves `t-powers.co.jp`.
...
- "Search T-Powers for this public profile name and return the official page metadata."
- "Extract public profile fields from this T-Powers detail URL."
- "Build a neutral CSV of visible T-Powers list entries with source links."
